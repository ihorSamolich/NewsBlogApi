...
namespace HackerNewsApi.Migrations
{
    ...
    [Migration("20240321102913_Add datacreated to comments table")]
    partial class Adddatacreatedtocommentstable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HackerNewsApi.Data.Entities.CommentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HackerNewsApi.Data.Entities.CommentEntity", b =>
                {
                    b.HasOne("HackerNewsApi.Data.Entities.CommentEntity", "Parent")
                        .WithMany("Replies")
